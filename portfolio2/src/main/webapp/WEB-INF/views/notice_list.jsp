...
<div id="boardLnbCommon">
    ...
    <ul class="lnb_sub">
        <li ><a href="notice.jsp" designElement="text">공지사항</a></li>
        <li ><a href="cs.do" designElement="text">자주 묻는 질문</a></li>
...
<ul class="bbs_top_wrap">
    ...
    <li class="right2">
        <span class="searchform">
            ...
            <button type="button" id="re_btn" class="btn_resp size_b" onclick="document.getElementById('re_btn').click">초기화</button>
        </span>
    </li>
</ul>
...
<!--반복구간 사항-->
<z:forEach items="${data}" var="notice">
<ul class="tbody">
<li class="mo_hide">
<span class="mtitle" designElement="text">번호:</span> ${notice.nidx}</li>
<li class="subject">
    ${notice.ntitle}
</li>

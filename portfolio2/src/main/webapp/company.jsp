...
<link rel="stylesheet" type="text/css" href="./css/slick.css"><!-- ë°ìí ì¬ë¼ì´ë -->
<link rel="stylesheet" type="text/css" href="./css/goods_info_style.css"><!-- ìíëì¤íë ì´ CSS -->
...
<link rel="stylesheet" type="text/css" href="./css/user.css" /><!-- ++++++++++++ ì¤í¨ ì¬ì©ì/ì ìì CSS ++++++++++++ -->
